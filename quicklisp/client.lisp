...
(defgeneric quickload (systems &key verbose silent prompt explain print-case &allow-other-keys)
  (:documentation
  ...
  (:method (systems &key
            ...
            (silent nil)
            (verbose *quickload-verbose*)
            ((:print-case *print-case*) :upcase) &allow-other-keys)
